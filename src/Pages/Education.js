        ...
        <div className="row">
          <div className="col-sm-11 offset-sm-1">
            <ul className="nav nav-tabs" data-aos="fade-down">
              ...
              <li className="nav-item">
                <a className="nav-link" data-bs-toggle="tab" href="#certificate">
                  Certificate
                </a>
              </li>
            </ul>
            <div className="tab-content">
              ...
              <div className="tab-pane fade" id="certificate">
                <div className="educationblock">
                  <div className="row"> 
                    <div className="col-sm-4">
                    {  /*     <h5 data-aos="fade-right">Jan, 2019 - May, 2019</h5>*/}
                  ...
                  <div className="educationright" data-aos="fade-left">
                        <h5>Udemy</h5>
                        <h6>certification - "Web developement 2022"</h6>
                        <h6>
                          - HTML, CSS, Bootstrap, Javascript, jQuery,React,Node js,Mongodb
                          <br />
